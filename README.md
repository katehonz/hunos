...
- **Nim 2.2.x compatibility** — cleaned up `std/sysrand` usage, removed stale `std/random` imports
- **Test suite reliability** — session tests use ephemeral ports to avoid local conflicts
